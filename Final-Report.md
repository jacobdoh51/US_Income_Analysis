...
- Question 3 (Jacob Doh): How does educational attainment relate to
  income? Does higher education levels tend to earn higher income?
...
![](Final-Report_files/figure-gfm/unnamed-chunk-13-1.png)<!-- -->
...
How does educational attainment relate to income? Does higher education
levels tend to earn higher income?

In this part, we analyze how total income varies across different levels
of educational attainment. Education attainment is represented as SCHL,
and total income appeared as PINCP.
...
The result (box plot) portrays adjusted total income (PINCP_adjusted)
across different levels of educational attainment (SCHL). There is a
clear positive relationship between education level and income. Higher
education attainment (master and bachelors) tend to have higher median
income compared to lower education attainment (high school and GED).
More in detail, the median income increases as education level rises,
suggesting that higher education not only earn more on average, but also
experience large variability (maybe due to a wide range of opportunities
and occupations). However, lower education groups show lower median
incomes, and more concentrated (maybe due to a lack of opportunities and
industries). Overall, the results indicate a strong positive
...
In this part, we analyze how total relate to poverty status.
Income-to-poverty ratio is represented as POVPIP, and total income
appeared as PINCP (Income is adjusted using ADJINC).
...
![](Final-Report_files/figure-gfm/unnamed-chunk-26-1.png)<!-- -->

The result above shows the relationship between poverty status (POVPIP)
and average adjusted income. There is a clear relationship between
income and poverty status. More in detail, groups with lower poverty
ratio (extreme poverty and below poverty) appear to have lower average
income compared to higher-income groups. This indicates that as the
POVPIP increases, average income also increases consistently
(individuals who further above the poverty threshold tend to earn more
money on average). Since this analysis focuses on average income across
groups, not just full income. Therefore, we can observed general income
levels between groups (not full variation in each category). Overall,
the result confirms that there is a decent relationship between income
and poverty status.
...
![](Final-Report_files/figure-gfm/unnamed-chunk-35-1.png)<!-- -->
...
![](Final-Report_files/figure-gfm/unnamed-chunk-36-1.png)<!-- -->
...
![](Final-Report_files/figure-gfm/unnamed-chunk-40-1.png)<!-- -->
...
![](Final-Report_files/figure-gfm/unnamed-chunk-41-1.png)<!-- -->
...
![](Final-Report_files/figure-gfm/unnamed-chunk-44-1.png)<!-- -->
...
![](Final-Report_files/figure-gfm/unnamed-chunk-46-1.png)<!-- -->
